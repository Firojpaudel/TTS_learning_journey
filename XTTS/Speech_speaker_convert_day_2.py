...
tts.voice_conversion_to_file(source_wav = "XTTS/sound_original/harvard.wav", target_wav = "XTTS/sound_original/original_sound_one.wav", file_path="XTTS/outputs/voice_converted.wav")